...
- Generated sitemap, search, and SEO audit artifacts are refreshed during `npm run build`; the Aug 14 Blog #93 rebuild produced 150 audited SEO routes, 148 sitemap URLs, and 168 search documents.
```
